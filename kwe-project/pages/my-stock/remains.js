  ...
  return (
    <div>
          {list.slice(20).map((item) => {
              ...
              return <div key={item.id} className="card mb-2" style={{ width: "100%"}}>
                  <img src="/assets/img/bootstrap-logo.svg" className="card-img-top mt-3 ms-3" alt="..." style={{height:"20px", width:"20px"}}/>
